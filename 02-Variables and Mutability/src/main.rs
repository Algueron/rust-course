...
fn main() {
    ...
    let favorite_beverage = "beer";

    println!("At the end of {season}, at exactly {event_time}, we scored {points_scored}, each touchdown counting as {} points.", TOUCHDOWN_POINTS);
}
