...
fn color_to_number_match(color: &str) -> u8 {
    match color {
        "red" => 1,
        "green" => 2,
        "blue" => 3,
...
fn main() {
    println!("red:{},blue:{},green:{},yellow:{}", color_to_number("red"), color_to_number("blue"), color_to_number("green"), color_to_number("yellow"));
    println!("red:{},blue:{},green:{},yellow:{}", color_to_number_match("red"), color_to_number_match("blue"), color_to_number_match("green"), color_to_number_match("yellow"));
    println!("5!={},4!={}", factorial_loop(5), factorial_loop(4));
    println!("5!={},4!={}", factorial(5), factorial(4));
}
